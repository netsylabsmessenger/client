...
public interface SerializerInterface {
    String serialize(MessageInterface message) throws SerializerException;

    <MessageType extends MessageInterface> MessageType deserialize(String message, Class<? extends MessageInterface> clazz) throws SerializerException;
}
