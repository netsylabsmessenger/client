...
import net.sylabs.messenger.client.protocol.consumer.ConsumerInterface;
import net.sylabs.messenger.client.protocol.consumer.TransactionalConsumerInterface;
...
public interface ConsumerFactoryInterface {
    <MessageType extends MessageInterface> ConsumerInterface<MessageType> createConsumer(
        ChannelInterface channel
    ) throws ConsumerFactoryException;

    <MessageType extends MessageInterface> TransactionalConsumerInterface<MessageType> createTransactionalConsumer(
        ChannelInterface channel
    ) throws ConsumerFactoryException;
}
