...
public interface TransactionalProducerInterface<MessageType extends MessageInterface> extends ProducerInterface<MessageType> {
    void commitProduction() throws ProducerException;
}
