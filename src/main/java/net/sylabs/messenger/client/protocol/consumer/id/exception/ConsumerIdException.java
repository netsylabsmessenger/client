...
package net.sylabs.messenger.client.protocol.consumer.id.exception;

import net.sylabs.messenger.client.protocol.consumer.exception.ConsumerException;

public class ConsumerIdException extends ConsumerException {
    public ConsumerIdException(String message) {
        super(message);
    }

    public ConsumerIdException(String message, Throwable cause) {
        super(message, cause);
    }
}
