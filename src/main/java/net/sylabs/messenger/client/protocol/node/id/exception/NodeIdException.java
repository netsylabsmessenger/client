...
package net.sylabs.messenger.client.protocol.node.id.exception;

import net.sylabs.messenger.client.protocol.node.exception.NodeException;

public class NodeIdException extends NodeException {
    public NodeIdException(String message) {
        super(message);
    }

    public NodeIdException(String message, Throwable cause) {
        super(message, cause);
    }
}
