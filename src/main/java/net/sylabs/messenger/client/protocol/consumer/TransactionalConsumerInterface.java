...
public interface TransactionalConsumerInterface<MessageType extends MessageInterface> extends ConsumerInterface<MessageType> {
    void commitConsummation() throws ConsumerException;

    void commitConsummation(int messageIndex) throws ConsumerException;
}
