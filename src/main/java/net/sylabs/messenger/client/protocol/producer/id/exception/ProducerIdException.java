...
package net.sylabs.messenger.client.protocol.producer.id.exception;

import net.sylabs.messenger.client.protocol.producer.exception.ProducerException;

public class ProducerIdException extends ProducerException {
    public ProducerIdException(String message) {
        super(message);
    }

    public ProducerIdException(String message, Throwable cause) {
        super(message, cause);
    }
}
