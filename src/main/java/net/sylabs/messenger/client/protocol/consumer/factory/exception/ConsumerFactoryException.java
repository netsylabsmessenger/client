...
package net.sylabs.messenger.client.protocol.consumer.factory.exception;

import net.sylabs.messenger.client.protocol.consumer.exception.ConsumerException;

public class ConsumerFactoryException extends ConsumerException {
    public ConsumerFactoryException(String message) {
        super(message);
    }

    public ConsumerFactoryException(String message, Throwable cause) {
        super(message, cause);
    }
}
