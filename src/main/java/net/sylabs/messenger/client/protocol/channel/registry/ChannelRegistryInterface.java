...
public interface ChannelRegistryInterface {
    Set<ChannelInterface> getChannels(ConsumerIdInterface consumerId) throws ChannelRegistryException;

    Set<ChannelInterface> getChannels(ProducerIdInterface producerId) throws ChannelRegistryException;

    Set<ChannelInterface> getChannels(ContractIdInterface contractId) throws ChannelRegistryException;
}
